...
MODULES=$(find extern -maxdepth 1 -mindepth 1 -type d -exec basename {} \;)

# Triples as: triple;arch;sysroot
TRIPLES=(
  "x64-osx;x86_64;macosx"
  "arm64-osx;arm64;macosx"
  #"x64-ios;x86_64;iphonesimulator" TODO:
  #"arm64-ios;arm64;iphoneos"  TODO:
)
...
for module in $MODULES; do
  for tripleEntry in "${TRIPLES[@]}"; do
    ...
    for config in "${CONFIGS[@]}"; do
      ...
      cmake -S "extern/${module}" -B "${BUILD_DIR}" -G "${GENERATOR}" \
